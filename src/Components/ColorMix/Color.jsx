    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 space-y-8">
         ...
         <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Mix colors with precision using weights</p>
        </div>

        {/* Select Colors Section */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-800">Color Selection</h2>
            <button
              onClick={resetAll}
              ...
              <div key={index} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
                <div className="flex items-center gap-4">
                  <div
                    ...
                    className="w-16 h-16 rounded-xl cursor-pointer border-4 border-white shadow-lg hover:scale-105 transition-transform"
                    style={{ backgroundColor: color }}
                  ></div>
                  <div className="flex-1 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-gray-800">{getColorName(color)}</span>
                      <button
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-xs font-bold text-gray-700">{color}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-4 text-white">
            <div className="flex justify-between items-center">
              <span className="font-medium">Total Mixture Weight</span>
              <span className="text-2xl font-bold">{getTotalWeight().toFixed(1)}g</span>
            </div>
          </div>
        </div>
        ...
        {showFinalColor && getTotalWeight() > 0 && (
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border border-green-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">Final Mixed Color</h3>
            <div className="flex flex-col items-center gap-4">
              ...
              ></div>
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-1">Color Code</p>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-lg font-bold text-gray-800">{finalMixedColor}</span>
                  <button
              ...
              <div className="grid grid-cols-8 gap-3 mb-4">
                {[
                  ...
                  <div
                    ...
                    className="w-10 h-10 rounded-lg cursor-pointer border-2 border-gray-300 hover:border-blue-500 hover:scale-110 transition-all shadow-sm"
                    style={{ backgroundColor: color }}
                  ></div>
                ))}
              </div>
